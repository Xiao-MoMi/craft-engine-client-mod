...
public record ClientboundCreativeModeTabItemsPacket(Action action,
    ...
    public void handle(Context context) {
        ...
        List<ItemStack> list = byteBuf.readCollection(ArrayList::new, _ -> ItemStack.OPTIONAL_STREAM_CODEC.decode(byteBuf));
    ...
    public enum Action {
        ...
        CLEAR(_ -> ItemManager.instance().clearCreativeTabItems()),
